...
All notable changes to the Llama Toolkit extension (`@thawee/llama-toolkit`) will be documented in this file.
...
- Updated repository URLs across documentation to point to the new `llama-toolkit` Github URL.

## [1.0.0] - 2026-05-22

### Added

- Initial release of the Llama Toolkit extension.
