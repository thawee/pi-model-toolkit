...
All notable changes to the Pi Custom Models Suite extension (`@thawee/pi-custom-models`) will be documented in this file.
...
- Updated repository URLs across documentation to point to the new `pi-custom-models` Github URL.
